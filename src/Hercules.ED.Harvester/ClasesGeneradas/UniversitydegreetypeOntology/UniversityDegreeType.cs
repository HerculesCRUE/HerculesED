...
namespace UniversitydegreetypeOntology
{
	[ExcludeFromCodeCoverage]
	public class UniversityDegreeType : GnossOCBase
	{

		public UniversityDegreeType() : base() { } 

		public UniversityDegreeType(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "http://w3id.org/roh/UniversityDegreeType", "http://w3id.org/roh/UniversityDegreeType", prefList, propList,identificador,listSecondaryEntity, null);
		...
		{
			return $"{resourceAPI.GraphsUrl}items/UniversitydegreetypeOntology_{ResourceID}_{ArticleID}";
		}
