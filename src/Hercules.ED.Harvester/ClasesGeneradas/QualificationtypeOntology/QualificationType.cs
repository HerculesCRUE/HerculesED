...
namespace QualificationtypeOntology
{
	[ExcludeFromCodeCoverage]
	public class QualificationType : GnossOCBase
	{

		public QualificationType() : base() { } 

		public QualificationType(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "http://w3id.org/roh/QualificationType", "http://w3id.org/roh/QualificationType", prefList, propList,identificador,listSecondaryEntity, null);
		...
		{
			return $"{resourceAPI.GraphsUrl}items/QualificationtypeOntology_{ResourceID}_{ArticleID}";
		}
