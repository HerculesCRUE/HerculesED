...
namespace HourscreditsectstypeOntology
{
	[ExcludeFromCodeCoverage]
	public class HoursCreditsECTSType : GnossOCBase
	{

		public HoursCreditsECTSType() : base() { } 

		public HoursCreditsECTSType(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
		...
		public virtual string RdfType { get { return "http://w3id.org/roh/HoursCreditsECTSType"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/HoursCreditsECTSType"; } }
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "http://w3id.org/roh/HoursCreditsECTSType", "http://w3id.org/roh/HoursCreditsECTSType", prefList, propList,identificador,listSecondaryEntity, null);
