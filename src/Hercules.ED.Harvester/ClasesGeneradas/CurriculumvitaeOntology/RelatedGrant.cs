...
using Grant = GrantOntology.Grant;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedGrant : GnossOCBase
	{

		public RelatedGrant() : base() { } 

		public RelatedGrant(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new Grant(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedGrant"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedGrant"; } }
		...
		[Required]
		public  Grant Vivo_relatedBy  { get; set;} 
