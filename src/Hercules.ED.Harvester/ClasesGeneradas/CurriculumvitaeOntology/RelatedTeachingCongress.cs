...
using TeachingCongress = TeachingcongressOntology.TeachingCongress;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedTeachingCongress : GnossOCBase
	{

		public RelatedTeachingCongress() : base() { } 

		public RelatedTeachingCongress(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new TeachingCongress(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedTeachingCongress"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedTeachingCongress"; } }
		public OntologyEntity Entity { get; set; }

		[RDFProperty("http://vivoweb.org/ontology/core#relatedBy")]
		[Required]
		public  TeachingCongress Vivo_relatedBy  { get; set;} 
