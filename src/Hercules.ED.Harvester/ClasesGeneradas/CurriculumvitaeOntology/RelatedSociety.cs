...
using Society = SocietyOntology.Society;

namespace CurriculumvitaeOntology
{
	public class RelatedSociety : GnossOCBase
	{

		public RelatedSociety() : base() { } 

		public RelatedSociety(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new Society(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedSociety"; } }
