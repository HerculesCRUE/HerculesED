...
namespace RelationshiptypeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelationshipType : GnossOCBase
	{

		public RelationshipType() : base() { } 

		public RelationshipType(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
		...
		public virtual string RdfType { get { return "http://w3id.org/roh/RelationshipType"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelationshipType"; } }
		[LABEL(LanguageEnum.es,"identifier")]
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "http://w3id.org/roh/RelationshipType", "http://w3id.org/roh/RelationshipType", prefList, propList,identificador,listSecondaryEntity, null);
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelationshipType_{ResourceID}_{ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://w3id.org/roh/RelationshipType>", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelationshipType_{ResourceID}_{ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://w3id.org/roh/RelationshipType\"", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/RelationshipType_{ResourceID}_{ArticleID}>", list, " . ");
				if(this.Dc_identifier != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelationshipType_{ResourceID}_{ArticleID}",  "http://purl.org/dc/elements/1.1/identifier", $"\"{GenerarTextoSinSaltoDeLinea(this.Dc_identifier)}\"", list, " . ");
				}
				if(this.Dc_title != null)
				{
							foreach (LanguageEnum idioma in this.Dc_title.Keys)
		...
		{
			return $"{resourceAPI.GraphsUrl}items/RelationshiptypeOntology_{ResourceID}_{ArticleID}";
		}
