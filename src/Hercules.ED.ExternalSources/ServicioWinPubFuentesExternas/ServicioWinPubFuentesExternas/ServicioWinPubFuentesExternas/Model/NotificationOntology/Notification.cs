...
namespace NotificationOntology
{
    public class Notification : GnossOCBase
    {
        ...
        public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
        {
            ...
            {
                AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Notification_{ResourceID}_{ArticleID}", "http://w3id.org/roh/gnossUser", $"<{this.Roh_gnossUser}>", list, " . ");
            }
        ...
        public override List<string> ToSearchGraphTriples(ResourceApi resourceAPI)
        {
            ...
            if (this.Roh_gnossUser != null)
            {
                ...
                string itemRegex = this.Roh_gnossUser;
