...
namespace SemanticShcolarAPI.Controllers
{    
    public class ConfigService
    {
        ...
        private string urlSemanticScholar_base {get;set;}
        ...
        /// </summary>
        /// <returns>URI del API de SemanticScholar.</returns>
        public string GetUrlSemanticScholar_base()
        {
            if (string.IsNullOrEmpty(urlSemanticScholar_base))
            {
                string connectionString = string.Empty;
                IDictionary environmentVariables = Environment.GetEnvironmentVariables();
                if (environmentVariables.Contains("urlSemanticScholar_base"))
                {
                    connectionString = environmentVariables["urlSemanticScholar_base"] as string;
                }
                else
                {
                    connectionString = configuracion["urlSemanticScholar_base"];
                }

                urlSemanticScholar_base = connectionString;
            }

            return urlSemanticScholar_base;
        }
