...
namespace SemanticScholarConnect.ROs.SemanticScholar.Controllers
{
    ...
    {
        public ROSemanticScholarController(string baseUri,Dictionary<string, Tuple<string,string, string, string,string,string>>  autores_orcid) : base(baseUri, autores_orcid)
        {
