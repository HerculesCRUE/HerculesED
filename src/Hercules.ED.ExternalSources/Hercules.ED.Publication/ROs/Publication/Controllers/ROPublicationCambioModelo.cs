...
{
    public class ROPublicationControllerJSON //: //ROScopusLogic
    {
        public ROPublicationLogic PublicationLogic;
        public ROPublicationControllerJSON(ROPublicationLogic PublicationLogic)
        {
