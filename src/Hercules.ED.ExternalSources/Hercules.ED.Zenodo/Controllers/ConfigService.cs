...
namespace ZenodoConnect.Controllers.API
{    
    public class ConfigService
    {
        ...
        private string UrlZenodo_base {get;set;}
 ...
 public string GetUrlZenodo_base()
        {
            if (string.IsNullOrEmpty(UrlZenodo_base))
            {
                string connectionString = string.Empty;
                IDictionary environmentVariables = Environment.GetEnvironmentVariables();
                if (environmentVariables.Contains("UrlZenodo_base"))
                {
                    connectionString = environmentVariables["UrlZenodo_base"] as string;
                }
                else
                {
                    connectionString = configuracion["UrlZenodo_base"];
                }

                UrlZenodo_base = connectionString;
            }

            return UrlZenodo_base;
        }
