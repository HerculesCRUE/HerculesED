...
using static Hercules.ED.DoiRabbitConsume.Program;
    ...
    public class ReadRabbitService
    {
        ...
        public bool ProcessItem(string pMessage)
        {
            ...
            if (message != null && message.Count() == 3)
            {
                ...
                {
                    // Creación de la URL.
                    Uri url = new Uri(string.Format(_configService.GetUrlPublicacion() + "GetRoPublication?pDoi={0}&pNombreCompletoAutor={1}", message[0], message[1]));
