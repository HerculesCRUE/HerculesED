...
namespace CurriculumvitaeOntology
{
	...
	public class RelatedOtherCollaboration : GnossOCBase
	{
		...
		public RelatedOtherCollaboration() : base() { } 

		public RelatedOtherCollaboration(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new Collaboration(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedOtherCollaboration"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedOtherCollaboration"; } }
		...
		[Required]
		public  Collaboration Vivo_relatedBy  { get; set;} 
