...
from utils_classification_multilabel import convert_examples_to_features_multi 
...
ALL_MODELS = "Look for the models at hugginface"
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (
                        ...
                        results, _ = evaluate(args, model, tokenizer, label2id, pad_token_label_id, mode="dev")
...
def evaluate(args, model, tokenizer, labels, pad_token_label_id, mode, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        if preds is None:
            ...
            sys.stderr.write("no predictions??\n")
        else:
    ...
    for i in range(len(out_label_ids)):
        ...
        #sys.stderr.write("example {}: \n \t label: {}\n \t predicted {} \n".format(i,out_label_ids[i],predicted))
        #one_label=[[1 if i in i in label_ids else 0 for i in range(0,22)]]
    ...
    results = {
        ...
        "report":classification_report(out_label_list, preds_list, digits=4, target_names=labels),
    }
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = Processor.create_from_csv(os.path.join(args.data_dir, mode+".csv_ml.csv"))
...
def main():
    ...
    parser.add_argument("--save_total_limit", type=int, default=5, help="Keep only the last X checkpoints.")
    parser.add_argument(
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        with open(output_test_predictions_file, "w") as writer:
            with open(os.path.join(args.data_dir, "test.csv_ml.csv"), "r") as f:
                example_id = 0
                for line in f:
                    if predictions[example_id]:
                        ...
                        output_line = 'ERROR' + "\t" + 'max seq length exceeded'
                        writer.write(output_line)
