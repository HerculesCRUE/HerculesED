...
namespace ImportadorWebCV.Sincro.Secciones
{
    class ActividadDocente : SeccionBase
    {
        ...
        /// </summary>
        public List<SubseccionItem> SincroFormacionSanitariaEspecializada([Optional] bool preimportar)
        {
            List<string> propiedadesItem = new List<string>() { "http://w3id.org/roh/XXXXXXXXXXXX", "XXXXXXXXXXXXXX", "XXXXXXXXXXXX" };
            string graph = "XXXXXXXXXXXXXXXXXX";
            string propTitle = "XXXXXXXXXXXXX";
            ...
            foreach (Entity entityXML in listadoAux)//TODO - check
            {
                FormacionSanitariaEspecializada formacionSanitariaEspecializada = new FormacionSanitariaEspecializada();
                formacionSanitariaEspecializada.descripcion = entityXML.properties.FirstOrDefault(x => x.prop == Variables.ActividadDocente.formacionSaniEspeTituloEspe)?.values.FirstOrDefault();
                formacionSanitariaEspecializada.fecha = entityXML.properties.FirstOrDefault(x => x.prop == Variables.ActividadDocente.formacionSaniEspeFechaInicio)?.values.FirstOrDefault();
                formacionSanitariaEspecializada.ID = Guid.NewGuid().ToString();
                entidadesXML.Add(formacionSanitariaEspecializada.ID, formacionSanitariaEspecializada);
            }

            //2º Obtenemos las entidades de la BBDD
            Dictionary<string, DisambiguableEntity> entidadesBBDD = FormacionSanitariaEspecializada.GetBBDD(mResourceApi, mCvID, graph, propiedadesItem);
        ...
        public List<SubseccionItem> SincroFormacionSanitariaIMasD([Optional] bool preimportar)
        {
            ...
            foreach (Entity entityXML in listadoAux)//TODO - check
            {
                ...
                formacionSanitariaIMasD.descripcion = entityXML.properties.FirstOrDefault(x => x.prop == Variables.ActividadDocente.formacionPosformacionTitulo)?.values.FirstOrDefault();
                formacionSanitariaIMasD.fecha = entityXML.properties.FirstOrDefault(x => x.prop == Variables.ActividadDocente.formacionPosformacionFechaInicio)?.values.FirstOrDefault();
            ...
            if (listadoFormacionSanitariaEspecializada.Count > 0)
            {
                foreach (CvnItemBean item in listadoFormacionSanitariaEspecializada)
                {
                    ...
                    if (!string.IsNullOrEmpty(item.GetStringPorIDCampo("030.020.000.020")))//TODO-check
                    {
                        ...
                        FormacionSanitariaEspecializadaEntidadTitulacion(item, entidadAux);
                        FormacionSanitariaEspecializadaEntidadRealizacion(item, entidadAux);
        ...
        private void FormacionSanitariaEspecializadaEntidadRealizacion(CvnItemBean item, Entity entidadAux)
        {
            /*
            ...
            new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadRealizacion, item.GetStringPorIDCampo("030.020.000.120")),
            ...
            */
            //Añado la referencia si existe Entidad
            UtilitySecciones.AniadirEntidad(mResourceApi, item.GetNameEntityBeanPorIDCampo("030.020.000.100"),
                Variables.ActividadDocente.formacionSaniEspeEntidadRealizacionNombre,
                Variables.ActividadDocente.formacionSaniEspeEntidadRealizacion, entidadAux);

            //Añado otros, o el ID de una preseleccion
            string valorTipo = !string.IsNullOrEmpty(item.GetStringPorIDCampo("030.020.000.130")) ? mResourceApi.GraphsUrl + "items/organizationtype_OTHERS" : item.GetStringPorIDCampo("030.020.000.120");

            entidadAux.properties.AddRange(UtilitySecciones.AddProperty(
                new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadRealizacion, valorTipo),
                new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadRealizacionOtros, item.GetStringPorIDCampo("030.020.000.130"))
            ));
        }

        private void FormacionSanitariaEspecializadaEntidadTitulacion(CvnItemBean item, Entity entidadAux)
        {
            /*
            ...
            new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadTitulacion, item.GetStringPorIDCampo("030.020.000.160")),
            ...
            */
            //Añado la referencia si existe Entidad
            UtilitySecciones.AniadirEntidad(mResourceApi, item.GetNameEntityBeanPorIDCampo("030.020.000.140"),
                Variables.ActividadDocente.formacionSaniEspeEntidadTitulacionNombre,
                Variables.ActividadDocente.formacionSaniEspeEntidadTitulacion, entidadAux);

            //Añado otros, o el ID de una preseleccion
            string valorTipo = !string.IsNullOrEmpty(item.GetStringPorIDCampo("030.020.000.170")) ? mResourceApi.GraphsUrl + "items/organizationtype_OTHERS" : item.GetStringPorIDCampo("030.020.000.160");

            entidadAux.properties.AddRange(UtilitySecciones.AddProperty(
                new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadTitulacion, valorTipo),
                new Property(Variables.ActividadDocente.formacionSaniEspeTipoEntidadTitulacionOtros, item.GetStringPorIDCampo("030.020.000.170"))
            ));
        }
            ...
            if (listadoFormacionSanitariaIMasD.Count > 0)
            {
                foreach (CvnItemBean item in listadoFormacionSanitariaIMasD)
                {
                    ...
                    if (!string.IsNullOrEmpty(item.GetStringPorIDCampo("030.030.000.010")))//TODO-check
                    {
                        ...
                        FormacionSanitariaIMasDEntidadOrganizadora(item, entidadAux);
                        FormacionSanitariaIMasDEntidadRealizacion(item, entidadAux);
        ...
        private void FormacionSanitariaIMasDEntidadRealizacion(CvnItemBean item, Entity entidadAux)
        {
            /*
            ...
            new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadRealizacion, item.GetStringPorIDCampo("030.030.000.080")),
            ...
            */
            //Añado la referencia si existe Entidad
            UtilitySecciones.AniadirEntidad(mResourceApi, item.GetNameEntityBeanPorIDCampo("030.030.000.060"),
                Variables.ActividadDocente.formacionPosformacionEntidadRealizacion,
                Variables.ActividadDocente.formacionPosformacionEntidadRealizacion, entidadAux);

            //Añado otros, o el ID de una preseleccion
            string valorTipo = !string.IsNullOrEmpty(item.GetStringPorIDCampo("030.030.000.090")) ? mResourceApi.GraphsUrl + "items/organizationtype_OTHERS" : item.GetStringPorIDCampo("030.030.000.080");

            entidadAux.properties.AddRange(UtilitySecciones.AddProperty(
                new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadRealizacion, valorTipo),
                new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadRealizacionOtros, item.GetStringPorIDCampo("030.030.000.090"))
            ));
        }

        private void FormacionSanitariaIMasDEntidadOrganizadora(CvnItemBean item, Entity entidadAux)
        {
            /*
            ...
            new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadTitulacion, item.GetStringPorIDCampo("030.030.000.120")),
            new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadTitulacionOtros, item.GetStringPorIDCampo("030.030.000.130")),
            */
            //Añado la referencia si existe Entidad
            UtilitySecciones.AniadirEntidad(mResourceApi, item.GetNameEntityBeanPorIDCampo("030.030.000.100"),
                Variables.ActividadDocente.formacionPosformacionEntidadTitulacionNombre,
                Variables.ActividadDocente.formacionPosformacionEntidadTitulacion, entidadAux);

            //Añado otros, o el ID de una preseleccion
            string valorTipo = !string.IsNullOrEmpty(item.GetStringPorIDCampo("030.030.000.130")) ? mResourceApi.GraphsUrl + "items/organizationtype_OTHERS" : item.GetStringPorIDCampo("030.030.000.120");

            entidadAux.properties.AddRange(UtilitySecciones.AddProperty(
                new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadTitulacion, valorTipo),
                new Property(Variables.ActividadDocente.formacionPosformacionTipoEntidadTitulacionOtros, item.GetStringPorIDCampo("030.030.000.130"))
            ));
        }
