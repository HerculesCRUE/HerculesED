...
namespace ImportadorWebCV.Exporta.Secciones.ActividadDocenteSubclases
{
    public class FormacionAcademicaSubclase : SeccionBase
    {
        ...
        private string graph = "impartedacademictraining";
        ...
        public void ExportaFormacionAcademica(Entity entity, string seccion, Dictionary<string, List<Dictionary<string, Data>>> MultilangProp, [Optional] List<string> secciones, [Optional] bool preimportar)
        {
