...
namespace ImportadorWebCV.Exporta.Secciones.ActividadDocenteSubclases
{
    public class ParticipacionCongresosFormacionDocente : SeccionBase
    {
        ...
        public void ExportaParticipacionCongresos(Entity entity, string seccion, Dictionary<string, List<Dictionary<string, Data>>> MultilangProp, [Optional] List<string> secciones, [Optional] bool preimportar)
        {
            if (!UtilitySecciones.CheckSecciones(secciones, "030.090.000.000"))
            {
                return;
            }
