...
namespace ImportadorWebCV.Exporta.Secciones.ExperienciaCientificaSubclases
{
    public class ResultadosTecnologicos:SeccionBase
    {
        ...
        public void ExportaResultadosTecnologicos(Entity entity, string seccion, Dictionary<string, List<Dictionary<string, Data>>> MultilangProp, [Optional] List<string> secciones, [Optional] bool preimportar)
        {
            if (!UtilitySecciones.CheckSecciones(secciones, "050.030.020.000"))
            {
                return;
            }
