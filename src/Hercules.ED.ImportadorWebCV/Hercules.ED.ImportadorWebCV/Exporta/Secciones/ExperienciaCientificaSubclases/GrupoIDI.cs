...
namespace ImportadorWebCV.Exporta.Secciones.ExperienciaCientificaSubclases
{
    public class GrupoIDI:SeccionBase
    {
        ...
        public void ExportaGrupoIDI(Entity entity, string seccion, Dictionary<string, List<Dictionary<string, Data>>> MultilangProp, [Optional] List<string> secciones, [Optional] bool preimportar)
        {
            if (!UtilitySecciones.CheckSecciones(secciones, "050.010.000.000"))
            {
                return;
            }
