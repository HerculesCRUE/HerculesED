...
namespace ImportadorWebCV.Exporta.Secciones.ActividadCientificaSubclases
{
    public class TrabajosCongresos : SeccionBase
    {
        ...
        public void ExportaTrabajosCongresos(string seccion, Dictionary<string, List<Dictionary<string, Data>>> MultilangProp, [Optional] List<string> listaId)
        {
            ...
            foreach (KeyValuePair<string, Entity> keyValue in listaEntidadesSP)
            {
                ...
                dicCodigosGoogleScholar.Add(new Tuple<string, string, string>("Double", "060.010.010.310", UtilityExportar.EliminarRDF(Variables.ActividadCientificaTecnologica.trabajosCongresosCitasGoogleScholar)));
