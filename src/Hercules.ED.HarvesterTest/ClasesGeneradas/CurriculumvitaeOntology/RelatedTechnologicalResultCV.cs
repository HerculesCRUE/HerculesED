...
{
	public class RelatedTechnologicalResultCV : GnossOCBase
	{

		public RelatedTechnologicalResultCV() : base() { } 

		public RelatedTechnologicalResultCV(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			this.Roh_expertTechnologist= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/expertTechnologist"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedTechnologicalResultCV"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedTechnologicalResultCV"; } }
		...
		internal override void GetProperties()
		{
			...
			propList.Add(new BoolOntologyProperty("roh:expertTechnologist", this.Roh_expertTechnologist));
		}
