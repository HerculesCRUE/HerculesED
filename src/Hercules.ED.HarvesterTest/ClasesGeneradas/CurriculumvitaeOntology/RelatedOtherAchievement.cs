...
{
	public class RelatedOtherAchievement : GnossOCBase
	{

		public RelatedOtherAchievement() : base() { } 

		public RelatedOtherAchievement(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
