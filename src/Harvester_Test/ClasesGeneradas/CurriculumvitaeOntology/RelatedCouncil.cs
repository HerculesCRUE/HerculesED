...
using Council = CouncilOntology.Council;

namespace CurriculumvitaeOntology
{
	public class RelatedCouncil : GnossOCBase
	{

		public RelatedCouncil() : base() { } 

		public RelatedCouncil(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new Council(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedCouncil"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedCouncil"; } }
		...
		[Required]
		public  Council Vivo_relatedBy  { get; set;} 
