...
{
	public class RelatedResearchActivityPeriod : GnossOCBase
	{

		public RelatedResearchActivityPeriod() : base() { } 

		public RelatedResearchActivityPeriod(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
