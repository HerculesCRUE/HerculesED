...
using TeachingProject = TeachingprojectOntology.TeachingProject;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedTeachingProjects : GnossOCBase
	{

		public RelatedTeachingProjects() : base() { } 

		public RelatedTeachingProjects(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new TeachingProject(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedTeachingProjects"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedTeachingProjects"; } }
		public OntologyEntity Entity { get; set; }

		[RDFProperty("http://vivoweb.org/ontology/core#relatedBy")]
		[Required]
		public  TeachingProject Vivo_relatedBy  { get; set;} 
