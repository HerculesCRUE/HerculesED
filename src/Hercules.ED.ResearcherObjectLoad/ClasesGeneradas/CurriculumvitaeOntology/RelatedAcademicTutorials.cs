...
using Tutorship = TutorshipOntology.Tutorship;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedAcademicTutorials : GnossOCBase
	{

		public RelatedAcademicTutorials() : base() { } 

		public RelatedAcademicTutorials(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
