...
namespace CurriculumvitaeOntology
{
	...
	public class CV : GnossOCBase
	{
		...
		public CV(SemanticResourceModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			this.Roh_noDuplicateGroup = new List<NoDuplicateGroup>();
			SemanticPropertyModel propRoh_noDuplicateGroup = pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/noDuplicateGroup");
			if(propRoh_noDuplicateGroup != null && propRoh_noDuplicateGroup.PropertyValues.Count > 0)
			{
				foreach (SemanticPropertyModel.PropertyValue propValue in propRoh_noDuplicateGroup.PropertyValues)
				{
					if(propValue.RelatedEntity!=null){
						NoDuplicateGroup roh_noDuplicateGroup = new NoDuplicateGroup(propValue.RelatedEntity,idiomaUsuario);
						this.Roh_noDuplicateGroup.Add(roh_noDuplicateGroup);
					}
				}
			}
			this.Roh_exportProfile = new List<ExportProfile>();
			SemanticPropertyModel propRoh_exportProfile = pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/exportProfile");
			if(propRoh_exportProfile != null && propRoh_exportProfile.PropertyValues.Count > 0)
			{
				foreach (SemanticPropertyModel.PropertyValue propValue in propRoh_exportProfile.PropertyValues)
				{
					if(propValue.RelatedEntity!=null){
						ExportProfile roh_exportProfile = new ExportProfile(propValue.RelatedEntity,idiomaUsuario);
						this.Roh_exportProfile.Add(roh_exportProfile);
					}
				}
			}
		...
		[RDFProperty("http://w3id.org/roh/noDuplicateGroup")]
		public  List<NoDuplicateGroup> Roh_noDuplicateGroup { get; set;}

		[RDFProperty("http://w3id.org/roh/exportProfile")]
		public  List<ExportProfile> Roh_exportProfile { get; set;}
		...
		internal override void GetEntities()
		{
			...
			if(Roh_noDuplicateGroup!=null){
				foreach(NoDuplicateGroup prop in Roh_noDuplicateGroup){
					prop.GetProperties();
					prop.GetEntities();
					OntologyEntity entityNoDuplicateGroup = new OntologyEntity("http://w3id.org/roh/NoDuplicateGroup", "http://w3id.org/roh/NoDuplicateGroup", "roh:noDuplicateGroup", prop.propList, prop.entList);
				entList.Add(entityNoDuplicateGroup);
				prop.Entity= entityNoDuplicateGroup;
				}
			}
			if(Roh_exportProfile!=null){
				foreach(ExportProfile prop in Roh_exportProfile){
					prop.GetProperties();
					prop.GetEntities();
					OntologyEntity entityExportProfile = new OntologyEntity("http://w3id.org/roh/ExportProfile", "http://w3id.org/roh/ExportProfile", "roh:exportProfile", prop.propList, prop.entList);
				entList.Add(entityExportProfile);
				prop.Entity= entityExportProfile;
				}
			}
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			if(this.Roh_noDuplicateGroup != null)
			{
			foreach(var item0 in this.Roh_noDuplicateGroup)
			{
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/NoDuplicateGroup_{ResourceID}_{item0.ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://w3id.org/roh/NoDuplicateGroup>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/NoDuplicateGroup_{ResourceID}_{item0.ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://w3id.org/roh/NoDuplicateGroup\"", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/NoDuplicateGroup_{ResourceID}_{item0.ArticleID}>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/CV_{ResourceID}_{ArticleID}", "http://w3id.org/roh/noDuplicateGroup", $"<{resourceAPI.GraphsUrl}items/NoDuplicateGroup_{ResourceID}_{item0.ArticleID}>", list, " . ");
				if(item0.Roh_noDuplicateId != null)
				{
					foreach(var item2 in item0.Roh_noDuplicateId)
					{
						AgregarTripleALista($"{resourceAPI.GraphsUrl}items/NoDuplicateGroup_{ResourceID}_{item0.ArticleID}", "http://w3id.org/roh/noDuplicateId", $"\"{GenerarTextoSinSaltoDeLinea(item2)}\"", list, " . ");
					}
				}
			}
			}
			if(this.Roh_exportProfile != null)
			{
			foreach(var item0 in this.Roh_exportProfile)
			{
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://w3id.org/roh/ExportProfile>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://w3id.org/roh/ExportProfile\"", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/CV_{ResourceID}_{ArticleID}", "http://w3id.org/roh/exportProfile", $"<{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}>", list, " . ");
				if(item0.Roh_checkedItems != null)
				{
					foreach(var item2 in item0.Roh_checkedItems)
					{
						AgregarTripleALista($"{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}", "http://w3id.org/roh/checkedItems", $"\"{GenerarTextoSinSaltoDeLinea(item2)}\"", list, " . ");
					}
				}
				if(item0.Roh_title != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/ExportProfile_{ResourceID}_{item0.ArticleID}",  "http://w3id.org/roh/title", $"\"{GenerarTextoSinSaltoDeLinea(item0.Roh_title)}\"", list, " . ");
				}
			}
			}
			...
			if(item3.Roh_relatedWorkSubmittedConferencesCV != null)
			{
				...
				if(item3.Roh_relatedWorkSubmittedConferencesCV.Roh_googleScholarCitationCount != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedWorkSubmittedConferencesCV_{ResourceID}_{item3.Roh_relatedWorkSubmittedConferencesCV.ArticleID}",  "http://w3id.org/roh/googleScholarCitationCount", $"{item3.Roh_relatedWorkSubmittedConferencesCV.Roh_googleScholarCitationCount.Value.ToString()}", list, " . ");
				}
				...
				if(item3.Roh_relatedWorkSubmittedConferencesCV.Roh_inrecsCitationCount != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedWorkSubmittedConferencesCV_{ResourceID}_{item3.Roh_relatedWorkSubmittedConferencesCV.ArticleID}",  "http://w3id.org/roh/inrecsCitationCount", $"{item3.Roh_relatedWorkSubmittedConferencesCV.Roh_inrecsCitationCount.Value.ToString()}", list, " . ");
				}
			...
			if(item10.Roh_relatedScientificPublicationCV != null)
			{
				...
				if(item10.Roh_relatedScientificPublicationCV.Roh_googleScholarCitationCount != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedScientificPublicationCV_{ResourceID}_{item10.Roh_relatedScientificPublicationCV.ArticleID}",  "http://w3id.org/roh/googleScholarCitationCount", $"{item10.Roh_relatedScientificPublicationCV.Roh_googleScholarCitationCount.Value.ToString()}", list, " . ");
				}
				...
				if(item10.Roh_relatedScientificPublicationCV.Roh_inrecsCitationCount != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedScientificPublicationCV_{ResourceID}_{item10.Roh_relatedScientificPublicationCV.ArticleID}",  "http://w3id.org/roh/inrecsCitationCount", $"{item10.Roh_relatedScientificPublicationCV.Roh_inrecsCitationCount.Value.ToString()}", list, " . ");
				}
			}
			...
			{
			foreach(var item2 in this.Roh_teachingExperience.Roh_teachingCongress)
			{
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://w3id.org/roh/RelatedTeachingCongress>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://w3id.org/roh/RelatedTeachingCongress\"", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/TeachingExperience_{ResourceID}_{this.Roh_teachingExperience.ArticleID}", "http://w3id.org/roh/teachingCongress", $"<{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}>", list, " . ");
				if(item2.Roh_isPublic != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}",  "http://w3id.org/roh/isPublic", $"\"{item2.Roh_isPublic.ToString()}\"", list, " . ");
				}
				if(item2.IdVivo_relatedBy != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedTeachingCongress_{ResourceID}_{item2.ArticleID}",  "http://vivoweb.org/ontology/core#relatedBy", $"<{item2.IdVivo_relatedBy}>", list, " . ");
				}
			}
			}
			if(this.Roh_teachingExperience.Roh_otherActivities != null)
			{
			foreach(var item3 in this.Roh_teachingExperience.Roh_otherActivities)
			{
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://w3id.org/roh/RelatedOtherActivities>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://w3id.org/roh/RelatedOtherActivities\"", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}>", list, " . ");
				AgregarTripleALista($"{resourceAPI.GraphsUrl}items/TeachingExperience_{ResourceID}_{this.Roh_teachingExperience.ArticleID}", "http://w3id.org/roh/otherActivities", $"<{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}>", list, " . ");
				if(item3.Roh_isPublic != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}",  "http://w3id.org/roh/isPublic", $"\"{item3.Roh_isPublic.ToString()}\"", list, " . ");
				}
				if(item3.IdVivo_relatedBy != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/RelatedOtherActivities_{ResourceID}_{item3.ArticleID}",  "http://vivoweb.org/ontology/core#relatedBy", $"<{item3.IdVivo_relatedBy}>", list, " . ");
				}
			}
			}
		...
		public override List<string> ToSearchGraphTriples(ResourceApi resourceAPI)
		{
			...
			foreach(var item0 in this.Roh_noDuplicateGroup)
			{
				AgregarTripleALista($"http://gnoss/{ResourceID.ToString().ToUpper()}", "http://w3id.org/roh/noDuplicateGroup", $"<{resourceAPI.GraphsUrl}items/noduplicategroup_{ResourceID}_{item0.ArticleID}>", list, " . ");
				if(item0.Roh_noDuplicateId != null)
				{
					foreach(var item2 in item0.Roh_noDuplicateId)
					{
						AgregarTripleALista($"{resourceAPI.GraphsUrl}items/noduplicategroup_{ResourceID}_{item0.ArticleID}", "http://w3id.org/roh/noDuplicateId", $"\"{GenerarTextoSinSaltoDeLinea(item2).ToLower()}\"", list, " . ");
					}
				}
			}
			}
			...
			foreach(var item0 in this.Roh_exportProfile)
			{
				AgregarTripleALista($"http://gnoss/{ResourceID.ToString().ToUpper()}", "http://w3id.org/roh/exportProfile", $"<{resourceAPI.GraphsUrl}items/exportprofile_{ResourceID}_{item0.ArticleID}>", list, " . ");
				if(item0.Roh_checkedItems != null)
				{
					foreach(var item2 in item0.Roh_checkedItems)
					{
						AgregarTripleALista($"{resourceAPI.GraphsUrl}items/exportprofile_{ResourceID}_{item0.ArticleID}", "http://w3id.org/roh/checkedItems", $"\"{GenerarTextoSinSaltoDeLinea(item2).ToLower()}\"", list, " . ");
					}
				}
				if(item0.Roh_title != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/exportprofile_{ResourceID}_{item0.ArticleID}",  "http://w3id.org/roh/title", $"\"{GenerarTextoSinSaltoDeLinea(item0.Roh_title).ToLower()}\"", list, " . ");
				}
			}
			}
			if(this.Roh_researchObject != null)
			...
			foreach(var item2 in this.Roh_teachingExperience.Roh_teachingCongress)
			{
				...
				if(item2.Roh_isPublic != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/relatedteachingcongress_{ResourceID}_{item2.ArticleID}",  "http://w3id.org/roh/isPublic", $"\"{item2.Roh_isPublic.ToString().ToLower()}\"", list, " . ");
				}
				if(item2.IdVivo_relatedBy != null)
				{
					Regex regex = new Regex(@"\/items\/.+_[0-9A-Fa-f]{8}[-]?(?:[0-9A-Fa-f]{4}[-]?){3}[0-9A-Fa-f]{12}_[0-9A-Fa-f]{8}[-]?(?:[0-9A-Fa-f]{4}[-]?){3}[0-9A-Fa-f]{12}");
					...
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/relatedteachingcongress_{ResourceID}_{item2.ArticleID}",  "http://vivoweb.org/ontology/core#relatedBy", $"<{itemRegex}>", list, " . ");
				}
			}
			}
			if(this.Roh_teachingExperience.Roh_otherActivities != null)
			...
			foreach(var item3 in this.Roh_teachingExperience.Roh_otherActivities)
			{
				...
				if(item3.Roh_isPublic != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/relatedotheractivities_{ResourceID}_{item3.ArticleID}",  "http://w3id.org/roh/isPublic", $"\"{item3.Roh_isPublic.ToString().ToLower()}\"", list, " . ");
				}
				if(item3.IdVivo_relatedBy != null)
				{
					Regex regex = new Regex(@"\/items\/.+_[0-9A-Fa-f]{8}[-]?(?:[0-9A-Fa-f]{4}[-]?){3}[0-9A-Fa-f]{12}_[0-9A-Fa-f]{8}[-]?(?:[0-9A-Fa-f]{4}[-]?){3}[0-9A-Fa-f]{12}");
					...
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/relatedotheractivities_{ResourceID}_{item3.ArticleID}",  "http://vivoweb.org/ontology/core#relatedBy", $"<{itemRegex}>", list, " . ");
				}
			}
			}
			if(this.Roh_teachingExperience.Roh_mostRelevantContributions != null)
