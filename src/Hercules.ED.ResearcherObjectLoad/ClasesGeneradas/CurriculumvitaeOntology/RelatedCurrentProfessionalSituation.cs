...
using Position = PositionOntology.Position;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedCurrentProfessionalSituation : GnossOCBase
	{

		public RelatedCurrentProfessionalSituation() : base() { } 

		public RelatedCurrentProfessionalSituation(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new Position(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedCurrentProfessionalSituation"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedCurrentProfessionalSituation"; } }
		public OntologyEntity Entity { get; set; }

		[RDFProperty("http://vivoweb.org/ontology/core#relatedBy")]
		[Required]
		public  Position Vivo_relatedBy  { get; set;} 
