...
using AcademicDegree = AcademicdegreeOntology.AcademicDegree;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedSpecialisedTrainings : GnossOCBase
	{

		public RelatedSpecialisedTrainings() : base() { } 

		public RelatedSpecialisedTrainings(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new AcademicDegree(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedSpecialisedTrainings"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedSpecialisedTrainings"; } }
		public OntologyEntity Entity { get; set; }

		[RDFProperty("http://vivoweb.org/ontology/core#relatedBy")]
		[Required]
		public  AcademicDegree Vivo_relatedBy  { get; set;} 
