...
using ThesisSupervision = ThesissupervisionOntology.ThesisSupervision;

namespace CurriculumvitaeOntology
{
	[ExcludeFromCodeCoverage]
	public class RelatedThesisSupervisions : GnossOCBase
	{

		public RelatedThesisSupervisions() : base() { } 

		public RelatedThesisSupervisions(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Vivo_relatedBy = new ThesisSupervision(propVivo_relatedBy.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
			this.Roh_isPublic= GetBooleanPropertyValueSemCms(pSemCmsModel.GetPropertyByPath("http://w3id.org/roh/isPublic"));
		}

		public virtual string RdfType { get { return "http://w3id.org/roh/RelatedThesisSupervisions"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/RelatedThesisSupervisions"; } }
		public OntologyEntity Entity { get; set; }

		[RDFProperty("http://vivoweb.org/ontology/core#relatedBy")]
		[Required]
		public  ThesisSupervision Vivo_relatedBy  { get; set;} 
