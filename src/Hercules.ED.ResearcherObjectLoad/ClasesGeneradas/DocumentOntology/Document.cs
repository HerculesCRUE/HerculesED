...
namespace DocumentOntology
{
	...
	public class Document : GnossOCBase
	{
		...
		[LABEL(LanguageEnum.es,"http://w3id.org/roh/impactIndexInYear")]
		...
		[LABEL(LanguageEnum.es,"http://w3id.org/roh/hasFile")]
		...
		[LABEL(LanguageEnum.es,"http://w3id.org/roh/quartile")]
