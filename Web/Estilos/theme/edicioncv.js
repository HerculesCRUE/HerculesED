...
var edicionCV = {
					...
					<div class="panel-heading" role="tab" id="publicaciones-tab">
						<p class="panel-title">
							<a style="display: flex;" data-toggle="collapse" data-parent="#${id}" href="#${id2}" aria-expanded="${expanded}" aria-controls="${id2}" data-expandable="false">
								...
								<span class="material-icons-outlined informationTooltip" style="width:25px; float:left; margin-left: 5px" id="${idTooltipSection}"></span>
    ...
    printPropertyEdit: function(iseditable, property, index) {
		...
		var spanTooltip = property.information ? `<span class="material-icons-outlined informationTooltip" style="width:25px; float:left; margin-left: 5px" id="tooltip${index}"></span>` : '';
